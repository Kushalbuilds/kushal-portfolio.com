    ...
    <div className="min-h-screen pt-24 pb-12 px-6 relative overflow-hidden bg-white text-black dark:bg-dark dark:text-white">
      ...
      >
        <h1 className="text-5xl md:text-7xl font-bold text-black dark:text-white mb-6">
          My <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-blue to-accent-purple">Projects</span>
        </h1>
        <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
          A showcase of my work and passion for creating innovative solutions
        </p>
      </motion.div>
